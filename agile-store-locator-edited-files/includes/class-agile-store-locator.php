...
class AgileStoreLocator {
	...
	public function add_admin_menu() {
		...
		if (current_user_can('delete_posts')){
			...
			add_Menu_page('Agile Store Locator', __('Lamers Locations','asl_admin'), 'delete_posts', 'asl-plugin', array($this->plugin_admin,'admin_plugin_settings'),$svg);
			...
			add_submenu_page( 'asl-plugin', __('Create New Location','asl_admin'), __('Add New Store','asl_admin'), 'delete_posts', 'create-agile-store', array($this->plugin_admin,'admin_add_new_store'));
			add_submenu_page( 'asl-plugin', __('Manage Locations','asl_admin'), __('Manage Locations','asl_admin'), 'delete_posts', 'manage-agile-store', array($this->plugin_admin,'admin_manage_store'));
			...
			//add_submenu_page( 'asl-plugin', __('Import/Export Locations','asl_admin'), __('Import Stores (Pro)','asl_admin'), 'delete_posts', 'import-store-list', array($this->plugin_admin,'admin_import_stores'));
			...
			add_submenu_page('asl-plugin-edit', __('Edit Location','asl_admin'), __('Edit Store','asl_admin'), 'delete_posts', 'edit-agile-store', array($this->plugin_admin,'edit_store'));
